...
public class EditActivity<EventEditView> extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void setContentView(int activity_edit) {
    }

    private Object findViewById(int toolbar) {
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_edit, (ViewGroup) menu);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        CursorLoader cursorLoader = new CursorLoader(this, CalendarContract.Calendars.CONTENT_URI,
